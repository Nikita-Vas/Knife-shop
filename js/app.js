(() => {
    ...
    (() => {
        ...
        function rangeInit() {
            ...
            if (rangeItems.length) rangeItems.forEach((rangeItem => {
                ...
                item.noUiSlider.on("update", (function(values, handle) {
                    items[handle].value = Math.round(values[handle]);
                }));
                items.forEach((function(input, handle) {
        ...
        document.addEventListener("DOMContentLoaded", (function() {
            ...
            var phone_inputs = document.querySelectorAll(".callback__inp");
